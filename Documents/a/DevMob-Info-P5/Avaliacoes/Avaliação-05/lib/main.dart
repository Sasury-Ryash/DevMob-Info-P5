          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CadastroPage(title: 'Adicione um(a) novo(a) professor(a)')),
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CadastroPage(title: 'Adicione um(a) novo(a) coordenador(a)')),
              );
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CadastroPage(title: 'Adicione um(a) novo(a) diretor(a)')),
              );
            },
          ),
          ListTile(
